        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" id="editTag">
                        <input type="hidden" id="id" name="id" value="<?php echo $tag['id']; ?>">
                        <div>
                            <label for="tag_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New
                                tag</label>
                            <input type="tag_name" id="tag_name" name="tag_name" value="<?php echo $tag["tag_name"] ?>"
