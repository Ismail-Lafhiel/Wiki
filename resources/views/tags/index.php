                    ...
                    <tbody>
                        <?php foreach ($tags as $tag): ?>
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">
                                    <?php echo \Carbon\Carbon::parse($tag['created_at'])->diffForHumans(); ?>
                                </td>
                                <td class="px-4 py-3">
                                    <?php echo \Carbon\Carbon::parse($tag['updated_at'])->diffForHumans(); ?>
                                </td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="tag-toggle-<?php echo $tag['id'] ?>"
                                        data-dropdown-toggle="tag-<?php echo $tag['id'] ?>-dropdown"
                                    ...
                                    <div id="tag-<?php echo $tag['id'] ?>-dropdown"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="tag-toggle-<?php echo $tag['id'] ?>">
                                            <li>
                                                <a href="/tags/edit/<?php echo $tag['id'] ?>"
