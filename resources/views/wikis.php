                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <?php foreach ($allWiki['tags'] as $tag): ?>
                                        <span
                                            class="text-white bg-primary-700 hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 font-normal rounded-full text-sm px-3.5 py-1.5 text-center mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-900"><?php echo($tag['tag_name']) ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
