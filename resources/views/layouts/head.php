        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button"
                        ...
                        <?php if (isset($_SESSION['user']['profile_path'])): ?>
                            <img class="w-8 h-8 rounded-full" src="<?php echo $_SESSION['user']['profile_path'] ?>"
                                alt="user photo">
                        <?php else: ?>
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="/wikis/show-all"
                            class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Wikis</a>
                    </li>
                </ul>
            </div>
        </div>
